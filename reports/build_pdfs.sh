...
for f in medgemma_vs_mistral medgemma_vs_biomedllama medgemma_vs_biomedllama_abnormality triphasic_waves triphasic_harvard harvard_llm_labeling summary all_prompts prompt_variants baseline; do
  [ -f "$f.md" ] || continue
